...
echo ""
echo "[7/7] Configuring build with GN (optimized for 10GB RAM)..."
cd build/src
...
echo ""
echo "[8/8] Starting compilation with nice -n 19 and -j4..."
